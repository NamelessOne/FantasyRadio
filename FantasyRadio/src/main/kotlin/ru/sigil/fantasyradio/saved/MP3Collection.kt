...
import ru.sigil.fantasyradio.utils.IFantasyRadioTracksCollection
 ...
 */
@Singleton
class MP3Collection @Inject constructor (context: Context): IFantasyRadioTracksCollection {
    private val mDatabase: SQLiteDatabase = context.openOrCreateDatabase("MP3Base", 0, null)
