...
private const val ACTION_BITRATE_CLICK_16 = "ru.sigil.fantasyradio.widget.ACTION_BITRATE_CLICK_16"
private const val ACTION_BITRATE_CLICK_32 = "ru.sigil.fantasyradio.widget.ACTION_BITRATE_CLICK_32"
private const val ACTION_BITRATE_CLICK_96 = "ru.sigil.fantasyradio.widget.ACTION_BITRATE_CLICK_96"
private const val ACTION_BITRATE_CLICK_112 = "ru.sigil.fantasyradio.widget.ACTION_BITRATE_CLICK_112"
private const val ACTION_PLAY_CLICK = "ru.sigil.fantasyradio.widget.ACTION_PLAY_CLICK"
private const val ACTION_STOP_CLICK = "ru.sigil.fantasyradio.widget.ACTION_STOP_CLICK"
...
class FantasyRadioWidgetProvider: AppWidgetProvider() {
    ...
    override fun onUpdate(context: Context?, appWidgetManager: AppWidgetManager,
        ...
        for (widgetId in allWidgetIds) {
            ...
            when (player?.currentStream()?.getBitrate()) {
                Bitrate.AAC_16 -> {
    ...
    private val titleChangedListener = { title: String ->
        widgetTitle = title
        onUpdate(context)
    }

    private val authorChangedListener = { author: String ->
        widgetTitle = author
        onUpdate(context)
    }

    private val playStateChangedListener = { _: PlayState -> onUpdate(context) }

    private val streamChangedListener = { _: IRadioStream -> onUpdate(context) }
}