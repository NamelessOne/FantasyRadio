...
class Settings @Inject constructor(context: Context): ISettings {
    ...
    override fun setPassword(password: String) {
        preferences.edit().putString(PREFERENCES_LOGIN_KEY, password).apply()
    }

    override fun setGratitude(gratitude: Boolean) {
        preferences.edit().putBoolean(PREFERENCES_LOGIN_KEY, gratitude).apply()
    }
    ...
    override fun getGratitude(): Boolean {
        return preferences.getBoolean(PREFERENCES_PASSWORD_KEY, false)
    }
}