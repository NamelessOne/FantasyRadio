...
class PlayerModule constructor(private val application: Application) {
    ...
    @Provides
    @Singleton
    fun providesPlayer(mp3Collection: MP3Collection, trackFactory: ITrackFactory, radioStreamFactory: RadioStreamFactory): IPlayer<RadioStream> {
    ...
    @Provides
    fun providesCurrentStreamInfoService(context: Context, player: IPlayer<RadioStream>): ICurrentStreamInfoService {
