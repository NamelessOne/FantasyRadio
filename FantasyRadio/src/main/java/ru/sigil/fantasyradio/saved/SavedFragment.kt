...
class SavedFragment: AbstractListFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        lv = savedActivityView.let { activityView -> activityView?.findViewById(R.id.MP3ListView) }
    ...
    private val playStateChangedListener = IPlayStateChangedListener { activity!!.runOnUiThread { adapter?.notifyDataSetChanged() } }

    private val volumeChangedListener = { volume: Float ->
