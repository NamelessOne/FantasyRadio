...
class MP3ArrayAdapter(context: Context, private val dbCursor: Cursor, private val deleteClickListener: View.OnClickListener,
    ...
    override fun bindView(view: View, context: Context, cursor: Cursor) {
        ...
        progressSeekBar.progress = (BASS.BASS_ChannelGetPosition(
                player!!.chan, BASS.BASS_POS_BYTE) * 100 / BASS.BASS_ChannelGetLength(player!!.chan,
                BASS.BASS_POS_BYTE)).toInt()
        progressSeekBar
